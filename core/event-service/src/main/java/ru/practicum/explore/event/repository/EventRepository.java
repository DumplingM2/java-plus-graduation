...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    @Query("""
            SELECT e FROM Event e WHERE e.initiatorId IN :users AND e.state IN :states AND e.category.id IN :categories AND e.eventDate >= :start AND e.eventDate <= :end
            """)
    ...
    @Query("""
            SELECT e FROM Event e WHERE e.initiatorId IN :users AND e.state IN :states AND e.eventDate >= :start AND e.eventDate <= :end
            """)
    ...
    @Query("""
            SELECT e FROM Event e WHERE e.initiatorId IN :users AND e.category.id IN :categories AND e.eventDate >= :start AND e.eventDate <= :end
            """)
    ...
    @Query("""
            SELECT e FROM Event e WHERE e.initiatorId IN :users AND e.eventDate >= :start AND e.eventDate <= :end
            """)
